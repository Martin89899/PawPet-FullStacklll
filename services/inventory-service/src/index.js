...
const swaggerOptions = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'PawPet Inventory Service API',
      version: '1.0.0',
      description: 'API para el servicio de inventario y farmacia de PawPet Veterinary Management System',
      contact: {
        name: 'PawPet Team',
